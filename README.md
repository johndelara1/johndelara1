<h1 align="left">Olá, eu sou o John de Lara</h1>

<p align="left">
  <img src="https://readme-typing-svg.herokuapp.com/?lines=Cientista+de+Dados+%7C+Machine+Learning+Engineer;Sistemas+de+Recomenda%C3%A7%C3%A3o+%7C+Big+Data+%7C+IA&theme=dark&left=true&width=520&height=45" />
</p>

### Sobre mim

Cientista de Dados / ML Engineer com foco em sistemas de recomendação, arquiteturas multi-objetivo e dados em larga escala. Atualmente trabalho no time de recomendação da **Globoplay**, desenvolvendo modelos distribuídos, embeddings e pipelines de backtest em GCP.
...
- Machine Learning e treinos distribuídos
- Engenharia de dados em larga escala (Spark, Databricks, BigQuery)
- Visão computacional (open source e Azure)
- Business Intelligence e geração de valor a partir de dados
